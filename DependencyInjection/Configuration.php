        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('order_item_class')
                    ...
                    ->isRequired()
                ->end()
                ->scalarNode('order_address_class')
                    ->cannotBeEmpty()
                    ->isRequired()
                ->end()
                ...
                ->scalarNode('address_class')
                    ...
                    ->isRequired()
                ->end()
                ->scalarNode('quantity_form_type_class')
                    ->cannotBeEmpty()
                    ->defaultValue('Kek\ShopBundle\Form\Type\QuantityType')
                ->end()
                ->scalarNode('checkout_address_form_type_class')
                    ->cannotBeEmpty()
                    ->defaultValue('Kek\ShopBundle\Form\Type\CheckoutAddressType')
                ->end()
